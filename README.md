<img width="858" height="539" alt="image" src="https://github.com/user-attachments/assets/f6f4a4fc-2e0c-4617-a2c8-e0bac41704b5" />
...
The dashboard adopts a multi-layered navigation structure positioned on the left panel, allowing users to switch between insight perspectives:
Main Board (Chart-Based Overview)
In-Analysis Board
Recommendations
Top Salesperson
Total Revenue
...
Centered typography and hierarchy
...
Top Region: North — Highest revenue-contributing region
Top Salesperson: NAN — Nancy Freehafer, leading sales representative
Top Customer: Customer D — Highest revenue contributor
...
Black (#000000): Base text and emphasis
Deep Red (#990414): Primary Netflix brand alignment
Coral Red (#C2382E): Regional and categorical visuals
Orange Red (#E36650): Sales highlights
Peach Orange (#F8977A): Visual backgrounds
Soft Neutral (#FBCCAE): Contrast and spacing
...
Top performing products: Coffee, Curry Sauce, Marmalade
...
Top Salesperson Logic
Data Model Overview

The dataset follows a star-schema-inspired structure with one-to-many relationships:
Sales Table: Revenue, Quantity, Product Name, Salesperson, Region, City
Customers Table: Customer ID, Customer Name
Products Table: Product Name, Category
Regions Table: Region, City
